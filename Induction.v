...
(** To prove interesting facts about numbers, lists, and other
    ...
    Here is the _principle of induction over natural numbers_: If
...
(** Recall the [incr] and [bin_to_nat] functions from the optional
    [binary] exercise in the [Basics] chapter. (If you haven't
    taken a look, take a look now.) Here's one way to solve it: *)
...
(** This exercise is a continuation of the previous exercise about
    binary numbers. This problem is _optional_ and
    _challenging_. Please do give it a go, but don't worry about
    finishing it if you have trouble.
...
(** $Date: 2017-11-15 19:55:41 -0800 (Wed, 15 Nov 2017) $ *)
